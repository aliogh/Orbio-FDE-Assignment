...
function LoginForm() {
  ...
  // After login, return to wherever the user was trying to go (or "/" by default).
  ...
  return (
    ...
    >
      <h1 className="text-xl font-bold text-stone-900 mb-2">Grupo Sazón</h1>
      <p className="text-sm text-stone-500 mb-6">
        Demo privada. Introduce la contraseña para continuar.
      </p>
      <input
        type="password"
        value={pw}
